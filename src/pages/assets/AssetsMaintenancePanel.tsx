...
export function AssetsMaintenancePanel({ boxes, selectedBoxId, maintenance, loading, busy, recordStateMap, onSelectBox, onOpen, onEdit, onVoid }: Props) {
